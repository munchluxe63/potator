...
extern void supervision_exec(unsigned short *backbuffer, unsigned char bRender);
extern void supervision_exec2(int16 *backbuffer, unsigned char bRender);
extern void supervision_exec3(int16 *backbuffer, unsigned char bRender);
extern void supervision_exec_fast(int16 *backbuffer, unsigned char bRender);
extern unsigned char supervision_load(uint8 *rom, uint32 romSize);
extern unsigned char supervision_update_input(void);
extern void supervision_set_colour_scheme(int ws_colourScheme);
extern M6502	*supervision_get6502regs(void);
extern void supervision_turnSound(unsigned char bOn);
